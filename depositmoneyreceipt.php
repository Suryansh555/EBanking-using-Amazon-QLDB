...
<thead> 
  ...
  <tr>
    ...
    <td scope="col">&nbsp;<?php echo  date('d-M-Y h:i A', strtotime($rstransaction['trans_date_time'])); ?></td> 
  </tr>
  <tr>
    <th scope="col">&nbsp;Deposited amount</th>
    <td scope="col">&nbsp;<?php echo $_SESSION['currency']; ?> <?php echo  $rstransaction['amount']; ?></td> 
  </tr>
  
  <tr>
    <th scope="col">&nbsp;Account Balance</th>
    <td scope="col">&nbsp;<?php echo $_SESSION['currency']; ?> <?php echo  $rscustac['acc_balance']; ?></td> 
  </tr>
