...
<thead>
  ...
  <tbody>
 <?php 
 $sql ="SELECT registered_payee.* FROM registered_payee INNER JOIN customer ON customer.customer_id=registered_payee.customer_id WHERE registered_payee.registered_payee_id!='0' AND registered_payee.customer_id='$_SESSION[customer_id]'";
